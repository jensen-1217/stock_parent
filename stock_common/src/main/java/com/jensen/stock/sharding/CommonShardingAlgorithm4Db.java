package com.jensen.stock.sharding;
 ...
 */
public class CommonShardingAlgorithm4Db implements StandardShardingAlgorithm<Date> {
...
//        //获取逻辑表名称
        ...
        if (valueRange.hasLowerBound()) {
            ...
            dsNames= dsNames.stream().filter(dsName->Integer.valueOf(dsName.substring(dsName.lastIndexOf("_")+1))>=year)
